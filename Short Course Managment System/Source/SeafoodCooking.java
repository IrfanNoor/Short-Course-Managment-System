/**   
'********************************************************************************'
'~ CPT23 Assignment 3 Short Course Management System  -  Seafood Cooking class  ~'
'********************************************************************************'
...
public class SeafoodCooking extends EnrolledStudent
{
   ...
   public SeafoodCooking(String name, String address, int age, int season, boolean isFirstCourse)
   {
