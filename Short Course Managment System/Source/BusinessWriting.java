/**   
'********************************************************************************'
'~ CPT23 Assignment 3 Short Course Management System  -  Business Writing class ~'
'********************************************************************************'
...
public class BusinessWriting extends EnrolledStudent
{
   ...
   public BusinessWriting(String name, String address, int age, int season, boolean isFirstCourse)
   {
