/**   
'********************************************************************************'
'~ CPT23 Assignment 2 Short Course Management System  -  Creative Writing class ~'
'********************************************************************************'
...
public class CreativeWriting extends Student
{
   ...
   public CreativeWriting(String name, String address, int age, double debt, double ageDiscount, double futherDiscount)
   {
