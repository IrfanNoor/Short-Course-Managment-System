/**   
'********************************************************************************'
'~ CPT23 Assignment 2 Short Course Management System  -  Italian Cooking class  ~'
'********************************************************************************'
...
public class ItalianCooking extends Student
{
   ...
   public ItalianCooking(String name, String address, int age, double debt, double ageDiscount, double futherDiscount)
   {
